 ...
 * 
 * See <a href="https://wiki.ushahidi.com/display/WIKI/Ushahidi+Public+API#UshahidiPublicAPI-Reports">Ushahidi Public API for Reports</a>
 * 
 * @author eyedol
 *
 */
public class ReportsTask {
	...
	/**
	 * Default constructor for ReportsTask.
	 * Sets the limit default value to 20.
	 */
	public ReportsTask() {
		this.limit = 20;
	}
	 ...
	 * @return A List containing all the report since a particular report ID was created.
	 */
	 ...
	 * @return A List containing all the reports within the specified maximum report ID.
	 */
